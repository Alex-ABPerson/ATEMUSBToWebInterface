...
namespace ATEMUSBToWebInterface.ATEM.Native
{
    ...
    public class WindowsNativeATEMInput : INativeATEMInput
    {
		...
		public INativeATEMAuxOut? GetAsAux()
        {
            _comObject.GetPortType(out _BMDSwitcherPortType t);
            if (t != _BMDSwitcherPortType.bmdSwitcherPortTypeAuxOutput) return null;

            return new WindowsNativeATEMAuxOut((IBMDSwitcherInputAux)_comObject);
        }
	...
	[SupportedOSPlatform("windows")]
	public class WindowsNativeATEMAuxOut : INativeATEMAuxOut
	{
		readonly IBMDSwitcherInputAux _comObject;
		public WindowsNativeATEMAuxOut(IBMDSwitcherInputAux comInterface) => _comObject = comInterface;

        public void SetInputSource(long val) => _comObject.SetInputSource(val);
		public void Dispose() => Marshal.ReleaseComObject(_comObject);
	}
    ...
    public class WindowsNativeATEMBlock : INativeATEMMixBlock, IBMDSwitcherMixEffectBlockCallback
    {
        ...
        public void Auto() => _comObject.PerformAutoTransition();
